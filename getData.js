...
function openModalProduitsOnStock(code) {
  ...
  // Pré-sélectionne le produit sur les 3 onglets (Modifier, Supprimer, Ajuster stock)
  // pour éviter d'avoir à le rechercher à nouveau si on change d'onglet
